...
import { ResultChartScreen } from "./screens/ResultChart";
      ...
      <View style={styles.mainBox}>
        ...
        <View style={styles.buttonBox}>
          <Button
            ...
            style={{ color: "white" }}
            onPress={() => this.props.navigation.navigate("NewPatient")}
          >
            New Patient
          </Button>
          ...
          <Button
            ...
            style={{ color: "white" }}
            onPress={() => this.props.navigation.navigate("ExistingPatient")}
          >
            Existing Patient
          </Button>
        </View>
